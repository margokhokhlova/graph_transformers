...
from .parallel import parallel_generate_walks, parallel_generate_walks_custom_id
...
class Node2Vec:
    ...
    def _generate_walks(self) -> list:
        ...
        walk_results = Parallel(n_jobs=self.workers, temp_folder=self.temp_folder, require=self.require)(
            delayed(parallel_generate_walks_custom_id)(self.d_graph,
                                             self.walk_length,
                                             len(num_walks),
                                             idx,
                                             self.sampling_strategy,
